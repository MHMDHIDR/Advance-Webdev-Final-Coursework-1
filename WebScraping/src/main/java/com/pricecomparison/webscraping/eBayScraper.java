...
//                        String[] models = SaveCase.getModels(phoneModels.toString());
...
//                                // Create PhoneCase object and save it to the database
//                                saveCase.saveVariant(variants, phoneCase, color, imageElement);
//                            }
//
//                            for (PhoneCaseVariation phoneCaseVariation: variants) {
//                                // Create PhoneCase object and save it to the database
//                                saveCase.savePrice(phoneCaseVariation, WEBSITE, productName, productPrice.substring(1), productUrl);
//                            }
//
//
//                        }
